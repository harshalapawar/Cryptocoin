...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Cryptcoin");
    QApplication::setOrganizationDomain("cryptcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Cryptcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Cryptcoin-Qt");
